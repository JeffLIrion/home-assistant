...
def _cv_template_number(cfg):
    ...
    if CONF_VALUE_TEMPLATE in cfg and CONF_SET_VALUE not in cfg:
        raise vol.Invalid('{} cannot be provided without {}'
...
class TemplateNumber(RestoreEntity):
    ...
    @property
    def name(self):
        """Return the name of the template number."""
        return self._name
